...
- Canonical context file: `docs/project-context.md`
- Incremental updates log: `docs/changes.md`
- Onboarding flow: `docs/agent-onboarding.md`
- Rule: keep changing business/project context in those docs, not duplicated in this file.
